...
- ** Model Transparency:** Real-time confusion matrix, accuracy, precision/recall metrics, and 2D Principal Component Analysis (PCA) projection of the active predictive algorithm.
